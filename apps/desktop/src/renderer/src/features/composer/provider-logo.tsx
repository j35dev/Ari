 ...
 * is needed. Rendered monochrome via `currentColor` — theme-aware, and brand
 * hex stays out of component code per the token rule. Kinds without official
 * art fall back to the mono letter mark.
