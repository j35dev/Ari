...
import { Music, Pause, Play, Search, SkipBack, SkipForward, Timer, Volume2 } from 'lucide-react'
import { Popover } from '@ari/ui/popover'
import { CliampAdapter } from './cliamp-adapter'
import { DISCONNECTED_MUSIC } from './music-types'
import type { FocusTrack, MusicService } from './music-types'
import {
  ...
  return (
    <div className="mr-2 shrink-0" style={{ WebkitAppRegion: 'no-drag' } as React.CSSProperties}>
      <Popover open={open} onOpenChange={setOpen}>
        ...
        <Popover.Content align="end" aria-label="Focus" className="w-64 max-w-[calc(100vw-24px)]">
          <MusicSection
