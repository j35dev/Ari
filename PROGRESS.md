...
- [x] M1.13 Motion kit: named variants/hooks from PLAN Â§6.4 + reduced-motion respect
...
- [x] M3.3 Projection framework: fold events â†’ read model, subscription deltas
...
- [x] M4.13 Hermes driver: probe flags at runtime, mapper + fixtures (synthesized fixtures â€” hermes CLI absent locally; re-record via record-fixture.ts when binary ships)
...
- [x] M4.16 Sessionâ†”driver binding: workspace cwd, env sanitization
...
- [x] M5.13 Perf test: 50k-block synthetic transcript â‰¥55fps scroll (delivered as 50k pure-transform budget + jsdom mount smoke of TranscriptView @2000 messages; fps needs a real compositor, unverifiable headless)
- [ ] M5.14 Transcript a11y pass (roles, announcements)

## M6 â€” Composer & steering
